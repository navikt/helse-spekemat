...
class Pølsefabrikk private constructor(
    ...
    companion object {
        fun gjenopprett(rader: List<PølseradDto>) = Pølsefabrikk(rader.map { Pølserad.fraDto(it) }.toMutableList())
    }
    ...
    private fun skalLageNyrad(pølse: Pølse) = pakken.isEmpty() || pakken[0].skalLageNyRad(pølse)
...
class TomPølsepakkeException(
    override val message: String?,
) : IllegalStateException()

class PølseFinnesIkkeException(
    override val message: String?,
) : IllegalStateException()
